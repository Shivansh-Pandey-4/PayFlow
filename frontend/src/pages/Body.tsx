    ...
    return (
        <div className="px-4">
            ...
            <section className="mt-8 flex justify-between items-center px-4">
                ...
                <h2 className="mt-1 flex items-center"><span className="text-lg font-semibold"> {loadingBalance ? "fetching userBalance..." : (!userBalance ? (createBalanceBtn ? <Button onClick={() => navigate("/createAccount")}>Create Account</Button> : "failed to get User Balance") : `Your Balance : Rs-${userBalance.account?.amount}`)} </span></h2>
